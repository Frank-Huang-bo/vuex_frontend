    ...
    <div class="jumbotron jumbotron-fluid jumbotron-bg d-flex align-items-end">
      <div class="container">
        <div class="p-3 bg-lighter">
          <h1 class="display-3 font-weight-bold">太空戰士XV 最後出清</h1>
          <p class="lead">Final Fantasy final stage, the end of Final Fantasy.</p>
        </div>
      </div>
    </div>
    ...
    <footer class="bg-light text-muted py-5">
      <div class="container">
        <ul class="list-inline text-center">
          <li class="list-inline-item">© Copright 2019 太空電商</li>
        ...
        <p class="text-center">以上圖片僅供學習使用，無商業用途</p>
      </div>
    </footer>
  </div>
</template>
...
.jumbotron-bg {
  /* banners.png */
  background: url('https://static.gamespot.com/uploads/original/1551/15511094/3082826-3000664-final-fantasy-xv.jpg');
